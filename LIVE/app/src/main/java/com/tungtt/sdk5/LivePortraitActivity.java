...
public class LivePortraitActivity extends AppCompatActivity implements View.OnClickListener, UZLivestreamCallback, CameraCallback {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (App.DF_DoMain_Api.equals("input")) {
            Toast.makeText(getApplicationContext(),"Please configure your workspace's information in App.java", Toast.LENGTH_SHORT).show();
            return;
        }
        findView();
    }
    // config action on view LivePortrait
    ...
    public void onPermission(boolean areAllPermissionsGranted) {
        if (areAllPermissionsGranted) {
            ...
            Toast.makeText(getApplicationContext(),"Cannot use this feature because user does not allow our permissions", Toast.LENGTH_SHORT).show();
            onBackPressed();
        }
    }
